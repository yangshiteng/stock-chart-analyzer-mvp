export const ANALYSIS_RESPONSE_SCHEMA = '{"action": "OPEN" | "ADD" | "HOLD" | "REDUCE" | "EXIT" | "WAIT", "orderType": "LIMIT" | "NONE", "limitPrice": string, "sizeSuggestion": string, "confidence": number, "summary": string, "levels": {"entry": string, "target": string, "invalidation": string}, "riskNote": string, "symbol": string | null, "timeframe": string}';
...
export const EXECUTION_PROMPT_CONFIG = {
  ...
  responseStyle: "Be concise, direct, execution-focused, and practical. If an order should be placed, use LIMIT. If no order should be placed, use NONE and set limitPrice to N/A.",
